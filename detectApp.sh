...
java -Xmx16g -cp .:soot-trunk.jar:soot-infoflow.jar:soot-infoflow-android.jar:slf5j-api-1.7.5.jar:slf4j-simple-1.7.5.jar:axml-2.0.jar soot.jimple.infoflow.android.TestApps.Test  "$filepath" "$platformpath" --noarraysize --aplength 1  > logs/"$filename".txt
